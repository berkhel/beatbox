...
public class BeatBoxFinal{
    ...
    private Track track;
/*
    public Map<Integer, String> instruments = Map.ofEntries( 
	    entry(35,"BassDrum"),
	    entry(42,"Closed Hi-Hat"),
	    entry(46,"Open Hi-Hat"),
	    entry(38,"Acoustic Snare"),
	    entry(49,"Crash Cymbal"),
	    entry(39,"Hand Clap"),
	    entry(50,"High Tom"),
	    entry(60,"Hi Bongo"),
	    entry(70,"Maracas"),
	    ...
	    entry(56,"Cowbell"),
	    entry(58,"Vibraslap"),
	    entry(47,"Low-mid Tom"),
	    entry(67,"High Agogo"),
	    entry(63,"Open Hi Conga")
	    );
*/
...
/*
	...
	saveState.addActionListener(e -> writeFile());
	buttonBox.add(saveState);

	JButton restoreState = new JButton("Restore");
	restoreState.addActionListener(e -> readFile());
...
//	setUpMidi();
	...
	try (ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream(jc.getSelectedFile().toString()))){
	...
	JFileChooser jc = new JFileChooser();
	jc.showSaveDialog(null);
	try(ObjectInputStream is = new ObjectInputStream(new FileInputStream(jc.getSelectedFile().toString()))){
